...
func TestCVEStruct(t *testing.T) { //nolint:gocyclo
	Convey("Unit test the CVE struct", t, func() {
		...
		// Image is found
		cveList, counters, pageInfo, err := cveInfo.GetCVEListForImage(ctx, repo1, "0.1.0", "", pageInput)
		So(err, ShouldBeNil)
		So(len(cveList), ShouldEqual, 1)
		So(len(counters), ShouldEqual, 4)
		So(counters["CRITICAL"], ShouldEqual, 0)
		So(counters["HIGH"], ShouldEqual, 0)
		So(counters["MEDIUM"], ShouldEqual, 1)
		So(counters["LOW"], ShouldEqual, 0)
		So(cveList[0].ID, ShouldEqual, "CVE1")
		So(pageInfo.ItemCount, ShouldEqual, 1)
		So(pageInfo.TotalCount, ShouldEqual, 1)

		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repo1, "1.0.0", "", pageInput)
		So(err, ShouldBeNil)
		...
		So(counters["CRITICAL"], ShouldEqual, 0)
		So(counters["HIGH"], ShouldEqual, 1)
		So(counters["MEDIUM"], ShouldEqual, 1)
		So(counters["LOW"], ShouldEqual, 1)
		So(pageInfo.ItemCount, ShouldEqual, 3)
		So(pageInfo.TotalCount, ShouldEqual, 3)

		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repo1, "1.0.1", "", pageInput)
		So(err, ShouldBeNil)
		...
		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repo1, "1.1.0", "", pageInput)
		So(err, ShouldBeNil)
		So(len(cveList), ShouldEqual, 1)
		So(cveList[0].ID, ShouldEqual, "CVE3")
		So(counters["CRITICAL"], ShouldEqual, 0)
		So(counters["HIGH"], ShouldEqual, 0)
		So(counters["MEDIUM"], ShouldEqual, 0)
		So(counters["LOW"], ShouldEqual, 1)
		So(pageInfo.ItemCount, ShouldEqual, 1)
		So(pageInfo.TotalCount, ShouldEqual, 1)

		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repo6, "1.0.0", "", pageInput)
		So(err, ShouldBeNil)
		...
		// Image is multiarch
		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repoMultiarch, "tagIndex", "", pageInput)
		So(err, ShouldBeNil)
		So(len(cveList), ShouldEqual, 1)
		So(len(counters), ShouldEqual, 4)
		So(cveList[0].ID, ShouldEqual, "CVE1")
		...
		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repo2, "1.0.0", "", pageInput)
		So(err, ShouldEqual, zerr.ErrScanNotSupported)
		So(len(cveList), ShouldEqual, 0)
		So(len(counters), ShouldEqual, 0)
		So(pageInfo.ItemCount, ShouldEqual, 0)
		So(pageInfo.TotalCount, ShouldEqual, 0)

		// Tag is not found
		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repo3, "1.0.0", "", pageInput)
		...
		// Scan failed
		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repo7, "1.0.0", "", pageInput)
		...
		// Tag is not found
		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, "repo-with-bad-tag-digest", "tag", "", pageInput)
		...
		// Repo is not found
		cveList, counters, pageInfo, err = cveInfo.GetCVEListForImage(ctx, repo100, "1.0.0", "", pageInput)
